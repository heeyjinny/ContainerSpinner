...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //데이터 data와 스피너를 연결해줄 ArrayAdapter클래스를 생성하여 변수(adapter)에 저장
        //ArrayAdapter 클래스 생성 시 제네릭<>을 사용해 데이터 타입 입력, data가 문자열로 입력됐기 때문에 타입은 String
        //ArrayAdapter 클래스 3개의 파라미터 :
